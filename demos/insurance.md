...
这个案例包含 **7 大板块、50+ 个字段、22 条联动规则**，板块顺序遵循真实保险填写习惯：

| 板块 | 内容 | 主要联动 |
|---|---|---|
| **投保人** | 姓名/性别/出生年份/联系电话/证件/与被保险人关系 | 出生年份 → 年龄；证件类型 → 证件号占位文本 |
| **被保险人** | 姓名/性别/出生年份/证件/职业 | 出生年份 → 年龄；证件类型 → 占位文本；职业 → 风险等级 |
| **险种方案** | 险种/期限/缴费期/频率/缴费方式/保额/附加险 | 险种 → 期限选项 + 缴费期选项；保额 → 是否需要体检 |
| **健康告知** | 身高/体重/吸烟/慢性病/手术史/家族史 | 身高+体重 → BMI → BMI状态 |
| **受益人** | 受益人类型 | 类型 → 三个字段显隐联动 |
| **核保提示** | 条件警告 | 5 个独立警告，各由不同条件触发 |
| **保费汇总** | 完整保费分解 | 7 个输入 → 基础费率 → 各项附加 → 年保费 → 每期金额 |
